...
export class MatrixTests extends Tests {
	...
	test_matrix_subtraction() {
		...
		this.assertEq(m2.minus(m1), m3);
		m2.minusEq(m1);
		this.assertEq(m2, m3);
		this.assertEq(m3.negative(), m4);
	}

	test_scalar_multiplication() {
		var m1 = new Matrix(1, 0, 2, 4);
		var m2 = new Matrix(-0.5, 0, -1, -2);
		this.assertEq(m1.sMult(-0.5), m2);
		m1.sMultEq(-0.5);
		this.assertEq(m1, m2);
	}
